...
---@class REC_ScriptTemplate.Server.Manager.PlayerManagerConfigBuilder: REC_Library.Server.Class.Manager.PlayerManagerConfigBuilder
local playerManagerConfigBuilder = svApi.Class.Manager.PlayerManagerConfigBuilder:new()
    :setOnStart(function (self)
        ---@cast self REC_ScriptTemplate.Server.Manager.PlayerManager
...
---@class REC_ScriptTemplate.Server.Manager.PlayerManager: REC_Library.Server.Class.Manager.PlayerManager
---@field info REC_ScriptTemplate.Server.Manager.PlayerManagerConfigBuilder
